                ...
                <!-- <li class="nav-item dropdown notification-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                        <div class="drodpown-title message">
                            <h6 class="d-flex justify-content-between"><span class="align-self-center">Notificaciones</span> <span class="badge badge-primary">9 Pendientes</span></h6>
                        </div>
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img src="{{ asset('storage/' . Auth::user()->foto_perfil) }}" alt="N/H" onerror="this.src='{{ asset('images/defaults.jpeg') }}'" class="rounded-circle">
                            </div>
                        </div>
                    </a>
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        ...
                        <div class="dropdown-item">
                            <a href="{{route ('settings')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> <span>Perfíl</span>
                            </a>
                        </div>
                        <div class="dropdown-item">
